...
urlpatterns = [
    ...
    url(r'^add_topic_extended_success/$', TemplateView.as_view(template_name='home/add_topic_extended_success.html'), name='add_topic_extended_success'),
    url(r'^edit_topic_extended/(?P<topic_id>\d+)/(?P<language>\w+)/$', EditTopicExtendedView.as_view(), name='edit_topic_extended'),
    url(r'^edit_topic_extended_success/$', TemplateView.as_view(template_name='home/edit_topic_extended_success.html'), name='edit_topic_extended_success'),
    url(r'^remove_topic_extended/(?P<pk>\d+)/$', RemoveTopicExtendedView.as_view(), name = 'remove_topic_extended'),
    url(r'^remove_topic_extended_success/$', TemplateView.as_view(template_name='home/remove_topic_extended_success.html'), name='remove_topic_extended_success'),

    url(r'^add_content_extended/$', AddContentExtendedView.as_view(), name = 'add_content_extended'),
    url(r'^add_content_extended_success/$', TemplateView.as_view(template_name='home/add_content_extended_success.html'), name='add_content_extended_success'),
    url(r'^edit_content_extended/(?P<content_id>\d+)/(?P<language>\w+)/$', EditContentExtendedView.as_view(), name='edit_content_extended'),
    url(r'^edit_content_extended_success/$', TemplateView.as_view(template_name='home/edit_content_extended_success.html'), name='edit_content_extended_success'),
    url(r'^remove_content_extended/(?P<pk>\d+)/$', RemoveContentExtendedView.as_view(), name = 'remove_content_extended'),
    url(r'^remove_content_extended_success/$', TemplateView.as_view(template_name='home/remove_content_extended_success.html'), name='remove_content_extended_success'),
]